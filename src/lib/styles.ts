export type projectCoverColors = 'gray' | 'blue' | 'purple' | 'green'

export const projectCoverStyles = {
    'gray': `radial-gradient(circle 500px at 50% 200px, #3e3e3e, transparent)`,
    'blue': `radial-gradient(circle 600px at 50% 50%, rgba(59,130,246,0.3), transparent)`,
    'purple': `radial-gradient(circle 500px at 50% 100px, rgba(139,92,246,0.4), transparent)`,
